...
<?php include('site-menu.php') ?>
    <section class="site-hero overlay" style="background-image: url(images/slider2.jpg)" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade-up">
            <span class="custom-caption text-uppercase text-white d-block  mb-3">Welcome To <span class="text-primary">Bandipur Inn</span>   </span>
    ...
    <!--used  room class for destinations as well-->
    <section class="section">
      <div class="container destinations">
        ...
        <div class="row">
          <div class="col-xs-6 col-sm-6 col-lg-3" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="images/bandipur_bazar.jpg" alt="Bandipur_bazar" class="img-fluid mb-3">
              </figure>
              <div class="text-center place-info" data-aos="fade-up">
                Bandipur Bazaar
              </div>
            </a>
          </div>
          ...
          <div class="col-xs-6 col-sm-6 col-lg-3" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="images/paragliding.jpg" alt="Paragliding" class="img-fluid mb-3">
              </figure>
              <div class="text-center place-info" data-aos="fade-up">
                Paragliding   
              </div>
          ...
          <div class="col-xs-6 col-sm-6 col-lg-3" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="images/hiking.jpg" alt="Hiking" class="img-fluid mb-3">
              </figure>
              <div class="text-center place-info " data-aos="fade-up">
                Hiking
              </div>
          ...
          <div class="col-xs-6 col-sm-6 col-lg-3" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="images/gumba.jpg" alt="Gumba" class="img-fluid mb-3">
              </figure>
              <div class="text-center place-info" data-aos="fade-up">
                Monastery
              </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            ...
            <p data-aos="fade-up" data-aos-delay="100">We provide the best home stay services with good sanitation and facilities</p>
          </div>
        </div>
        <div class="row">
    ...
    <section class="section bg-image overlay" style="background-image: url('images/background.jpg');">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            <h2 class="heading text-light" data-aos="fade-up">Special Packages</h2>
          </div>
        </div>
          <div class="row">
            <div class="col-md-6 col-lg-4" data-aos="fade-up">
              <div class="packages p-4 mb-3">
              <h2 class="text-light text-center">Travel Pack</h2>
              This luxurious heritage
              deluxe is up to 390 sq. ft. and comprises of a living space, bathroom 
              <ul>
                <li> Telephone</li>
                <li> Opulent Bathroom</li>
                <li> AC & Heating</li>
                <li> Private WiFi</li>
